    ...
    <main className="w-[100vw] h-[100vh] flex justify-center items-center">
      ...
      <section className="w-5/6 min-h-[600px] max-h-[700px]">
        ...
        <div className="w-full h-[580px] flex justify-between items-center">
          <div className="w-1/2 h-full mr-2 font-medium text-base">{para}</div>
        ...
        <div className="w-full h-[56px] flex justify-end items-center mt-2">
          ...
          <button className="fontType-2 relative text-[#2EC4B6] border-2 border-solid border-[#2EC4B6] py-2 px-10 w-52 text-2xl hoverEffect2">
            Reset
          </button>
        </div>
      </section>
